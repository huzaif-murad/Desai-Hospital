          ...
          <ul className="flex flex-col items-center gap-2 mt-5 px-5 text-lg font-medium">
            ...
            {token ? (
              <>
                ...
                <NavLink onClick={() => setShowMenu(false)} to="/my-reports">
                  <p className="px-4 py-2 rounded inline-block">MY REPORTS</p>
                </NavLink>
                <p
                  onClick={() => {
                    logout();
                  ...
                  className="px-4 py-2 rounded inline-block text-red-500"
                >
                  LOGOUT
                </p>
              </>
